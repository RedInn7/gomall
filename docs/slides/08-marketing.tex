...
\begin{tikzpicture}[node distance=5mm and 10mm]
  ...
  \node[node-box,below=of api,node-alert] (cs1) {话术 A\\70001 限流};
  \node[node-box,below=of sw,node-alert] (cs2) {话术 B\\已抢光};
  \node[node-box,below=of lua,node-alert] (cs3) {话术 C\\已领过};
