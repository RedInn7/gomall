...
\srcnote{stressTest/REPORT.md 链路压测表 第 5--6 行；repository/cache/coupon.go:30--44；internal/coupon/repo.go:44--90 ClaimWithDBLock、:127--137 generateCouponCode}
\end{frame}
...
\end{itemize}
\srcnote{internal/skill/service.go:113--123 SkillProduct；商品独立 skill.SkillProduct 表}
\end{frame}
...
\srcnote{internal/skill/service.go:113--123；internal/skill/routes.go:12--25 秒杀路由}
\end{frame}
...
\begin{description}\small
  ...
  \item[coupon DB 锁路径（clause.Locking + 随机券码）]\srcnote{internal/coupon/repo.go:44--90、:127--137}
  ...
  \item[秒杀业务]\srcnote{internal/skill/service.go:113--123}
