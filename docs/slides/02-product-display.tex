...
\begin{frame}{穿透：短 TTL 空值标记挡住"不存在"的 id}
\begin{itemize}
...
\begin{frame}[fragile]{雪崩：TTL 随机抖动打散过期时刻}
\begin{itemize}
...
\begin{frame}{惊群：singleflight 合并同实例并发回源}
\begin{tikzpicture}[node distance=8mm and 14mm]
...
\begin{frame}{业务侧视角：list 延迟从哪来、怎么平移到游标分页}
\begin{itemize}
...
\begin{frame}{对照数字：24.5 RPS / p95 2.5s 的来源}
\begin{tabular}{@{}lrr@{}}
\toprule
接口 & 实测 RPS & p95 \\
\midrule
...
\begin{frame}[fragile]{COUNT(*) 代码与其代价}
