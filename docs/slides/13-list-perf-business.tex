...
\begin{itemize}
  ...
  \item 运营做"双 11 我的订单"推送 = 1 分钟 10 万人点开，旧版 8.3 RPS 只服务 500 人，剩下 99{,}500 全超时——\textbf{活动效果差}就是这么来的。
\end{itemize}
\keypoint{运营前问后端"这接口扛多少 RPS"——gomall 现在的答案应是 58K，不是 8.3。}
\srcnote{routes/router.go:78--79 同业务两个 endpoint 便于 AB 对比}
\end{frame}
