...
## 时间表（约 45 分钟，最多 55 分钟）

| 时间 | 内容 | 检查问题 |
|---|---|---|
| 0–6 分钟 | 业务角色与购物主线 | 系统究竟替谁承担风险？ |
| 6–16 分钟 | 请求分层与数据边界 | 一个请求经过哪些门，事实放在哪里？ |
| 16–32 分钟 | 浏览、下单、支付 | 哪些动作必须同步完成？ |
| 32–40 分钟 | 身份、权限与幂等 | “你是谁”和“能做什么”有何区别？ |
| 40–45 分钟 | 代码走读与承接问题 | 订单创建成功后，系统还欠哪些异步工作？ |
| 45–55 分钟 | 提问与机动 | 不追加新知识点 |

讲解边界：本讲不展开库存 Lua、Outbox、MQ 削峰、搜索排序和支付通道差异。
