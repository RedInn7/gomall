...
| 部分 | 要回答的问题 | 时间 |
|---|---|---:|
| 业务边界 | 什么条件满足后才能给卖家放款 | 5 min |
| 事件链路 | 为什么使用 Outbox 和异步消费者 | 8 min |
| 结算事务 | 卖家余额、流水和状态怎样一起提交 | 11 min |
| 退款竞争 | 钱从托管退，还是从卖家扣 | 9 min |
| 幂等与故障 | 重复、乱序、失败时怎样守住资金 | 4 min |
| 测试 | 怎样证明一笔钱只放一次 | 3 min |
| **合计** |  | **40 min** |
