...
export const ENDPOINTS: Endpoint[] = [
  ...([
    ...
    ['GET', '/api/v1/admin/payment-anomalies', '管理员', '异常款列表', { page: 1, page_size: 50, status: 'pending_review' }],
    ['GET', '/api/v1/admin/payment-anomalies/:id', '管理员', '异常款详情', { id: 0 }],
    ['POST', '/api/v1/admin/payment-anomalies/:id/status-transitions', '管理员', '记录异常款处置', {
      id: 0,
