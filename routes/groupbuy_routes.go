...
func RegisterGroupbuyRoutes(public *gin.RouterGroup, authed *gin.RouterGroup) {
	public.GET("/groupbuy/:id", api.GroupbuyShowHandler())
	authed.POST("/groupbuy/create", api.GroupbuyCreateHandler())
	authed.POST("/groupbuy/:id/join", api.GroupbuyJoinHandler())
}
